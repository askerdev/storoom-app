...
export const AccordionNavigationItemContainer = styled.div<{ $open: boolean }>`
  width: 100%;
  ${(props) =>
    props.$open &&
    css`
...
export const AccordionNavigationItemContent = styled.div<{
  $height: number;
  $open: boolean;
}>`
...
export const AccordionNavigationItemTrigger = styled.button<{
  $open: boolean;
}>`
  display: flex;
...
export const AccordionNavigationLessonContainer = styled.div`
  width: 100%;
  ${media.lg`
    position: absolute;
    right: 0;
...
export const AccordionNavigationLessonLink = styled.a`
  height: 32px;
  width: 100%;
  display: flex;
...
export const AccordionNavigationLessonHomeworkStatus = styled.div<{
  $color: TColor;
}>`
  width: 10px;
  height: 10px;
